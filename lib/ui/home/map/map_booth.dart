...
class BoothMapPage extends StatefulWidget {
  const BoothMapPage({super.key});

  @override
  State<BoothMapPage> createState() => _BoothMapPageState();
}

class _BoothMapPageState extends State<BoothMapPage> {
